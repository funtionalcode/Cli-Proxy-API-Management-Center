...
describe('plugin release version helpers', () => {
  it('normalizes GitHub repository slugs from supported repository formats', () => {
    ...
    expect(getGitHubRepositorySlug('git@github.com:router-for-me/demo.git')).toBe(
      'router-for-me/demo'
    );
    expect(getGitHubRepositorySlug('ssh://git@github.com/router-for-me/demo.git')).toBe(
      'router-for-me/demo'
    );
    ...
    expect(getGitHubRepositorySlug('gitlab.com/router-for-me/demo')).toBe('');
