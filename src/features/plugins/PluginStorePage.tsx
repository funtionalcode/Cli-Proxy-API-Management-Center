...
function PluginInstallOptionsModal({
  ...
  const manualVersionErrorId = `${versionModeLabelId}-manual-error`;
          ...
          {versionMode === 'manual' ? (
            <div className={styles.installVersionPanel}>
              <Input
                ...
                autoComplete="off"
                spellCheck={false}
                aria-label={t('plugin_store.install_version_label')}
                aria-invalid={manualVersionInvalid}
                aria-describedby={manualVersionInvalid ? manualVersionErrorId : undefined}
              />
              {manualVersionInvalid ? (
                <p id={manualVersionErrorId} className={styles.installVersionWarning}>
